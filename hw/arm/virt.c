...
{
    /*
     * For Realms, the firwmare image is placed directly in the guest's
     * RAM area.  The associtation between the final location in the
                           ...
                           MemoryRegion *secure_sysmem)
{
    ...
    /*
     * For Realms the firmware images is stored in the guest's address
